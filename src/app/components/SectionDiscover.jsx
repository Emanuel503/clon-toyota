...
export default function SectionDiscover() {
    ...
    return (
        <section className='mb-10'>
            ...
            <div className={`grid-cols-12 mx-14 xl:mx-40 gap-5 transition-all duration-700 ${activeTab === 1 ? 'grid' : 'hidden'}`}>
                <LargeCard
                    color="3e3a3b"
                    image='/supra.jpg'
            ...
            <div className={`grid-cols-12 mx-14 xl:mx-40 gap-5 transition-all duration-700 ${activeTab === 2 ? 'grid' : 'hidden'}`}>
                <MediumCard
            ...
            <div className={`grid-cols-12 mx-14 xl:mx-40 gap-5 transition-all duration-700 ${activeTab === 3 ? 'grid' : 'hidden'}`}>
                <LargeCard
                    color="363949"
                    image='/finance.jpg'
