...
export default function SectionVideo() {
  return (
    <section className='h-screen bg-[#eae7e3] py-12 flex flex-col items-center'>
        ...
        <iframe className='w-2/3 h-full' src="https://www.youtube.com/embed/Ju0DdwUybXk?si=FWWRjOPzPDlKj25H" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </section>
  )
}
