...
export default function MediumCard({link = "/", image = "", imageDescription = "", title = "", subtitle = "", description = "", button = "Ver más" }) {
    ...
    return (
        <div className='col-span-12 md:col-span-6 rounded-lg relative'>
            <Link href={link} onMouseEnter={(e) => hadlerDiscoverHover(e, true)} onMouseLeave={(e) => hadlerDiscoverHover(e, false)} className="w-full h-full absolute bg-gradient-to-t from-[#12120f] rounded-lg">
                <div className='absolute bottom-0 text-white mx-5 mb-8'>
                    ...
                    <p className='text-sm mb-5 hidden'>{description}</p>
